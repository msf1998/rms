...
public final class CryptUtil {
    ...
    public static String decryptByDES(String encode) {
        try {
            ...
            byte[] bytes = des.doFinal(Base64Utils.decodeFromUrlSafeString(encode));
    ...
    public static String getAuthorityContent(String authority) {
        ...
        try {
            ...
            br.close();
            PublicKey publicKey = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(Base64Utils.decodeFromUrlSafeString(sb.toString())));
    ...
    private static String decodeByRSAPublicKey(String code,PublicKey publicKey) {
        ...
        try {
            ...
            byte[] res = rsa.doFinal(Base64Utils.decodeFromUrlSafeString(code));
